...
export const templates: TemplateDescriptor[] = [
  ...
  { id: "dockerignore.tmpl", description: "Docker build-context ignore file" },
  {
    id: "docker-compose.yml.tmpl",
    description: "Compose service for the server (http transport)",
  },
  { id: "fly.toml.tmpl", description: "Fly.io deployment config" },
  { id: "render.yaml.tmpl", description: "Render Blueprint deployment config" },
  { id: "railway.json.tmpl", description: "Railway deployment config" },
